...
async def run():
    ...
    print("\"Government\" -> Create \"Transcript2\" Schema")
    transcript2 = {
        'name': 'Transcript22',
        'version': '1.2',
    ...
    print("\"Government\" -> Send \"Transcript2\" Schema to Ledger")
    ...
    print("\"government\" -> Get \"Transcript2\" Schema from Ledger")
    ...
    print("\"government\" -> Create and store in Wallet \"government Transcript2\" Credential Definition")
    ...
    print("\"government\" -> Send  \"government Transcript2\" Credential Definition to Ledger")
    ...
    theUniversity['alice_transcript_cred_values'] = json.dumps({
        ...
        "student_first_name": {"raw": "Alice", "encoded": "5893255682023721427"},
        "student_last_name": {"raw": "Garcia", "encoded": "1327274877492361491"},
    ...
    # ------------------------------------------------------------
    #  Alice getting transcript2 from government

    print("==============================")
    print("=== Getting Transcript2 with government ==")
    print("==============================")
    ...
    print("\"government\" -> Create \"Transcript2\" Credential Offer for Alice")
    ...
    print("\"government\" -> Send \"Transcript2\" Credential Offer to Alice")
    
    # Over Network 
    alice['transcript2_cred_offer'] = government['transcript2_cred_offer']

    print(alice['transcript2_cred_offer'])

    # Alice prepares a transcript2 credential request

    transcript2_cred_offer_object = json.loads(alice['transcript2_cred_offer'])

    alice['transcript2_schema_id'] = transcript2_cred_offer_object['schema_id']
    alice['transcript2_cred_def_id'] = transcript2_cred_offer_object['cred_def_id']

    # print("\"Alice\" -> Create and store \"Alice\" Master Secret in Wallet")
    # alice['master_secret_id'] = await anoncreds.prover_create_master_secret(alice['wallet'], None)

    print("\"Alice\" -> Get \"government Transcript2\" Credential Definition from Ledger")
    (alice['government_transcript2_cred_def_id'], alice['government_transcript2_cred_def']) = \
        await get_cred_def(alice['pool'], alice['did'], alice['transcript2_cred_def_id'])

    print("\"Alice\" -> Create \"Transcript2\" Credential Request for government")
    (alice['transcript2_cred_request'], alice['transcript2_cred_request_metadata']) = \
        await anoncreds.prover_create_credential_req(alice['wallet'], alice['did'],
                                                     alice['transcript2_cred_offer'],
                                                     alice['government_transcript2_cred_def'],
                                                     alice['master_secret_id'])

    print("\"Alice\" -> Send \"Transcript2\" Credential Request to government")

    # Over Network
    government['transcript2_cred_request'] = alice['transcript2_cred_request']


    # University issues credential to alice ----------------
    print("\"government\" -> Create \"Transcript2\" Credential for Alice")
    ...
    print("\"government\" -> Send \"Transcript2\" Credential to Alice")
    print(government['transcript2_cred'])
    # Over the network
    alice['transcript2_cred'] = government['transcript2_cred']

    print("\"Alice\" -> Store \"Transcript2\" Credential from government")
    _, alice['transcript2_cred_def'] = await get_cred_def(alice['pool'], alice['did'],
                                                         alice['transcript2_cred_def_id'])

    await anoncreds.prover_store_credential(alice['wallet'], None, alice['transcript2_cred_request_metadata'],
                                            alice['transcript2_cred'], alice['transcript2_cred_def'], None)
    
    print("\n\n>>>>>>>>>>>>>>>>>>>>>>.\n\n", alice['transcript2_cred_def'])
